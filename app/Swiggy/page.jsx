...
import { setLocation } from '@/utils/slice/userSlice';
...
const RestaurantCard = React.memo(({ 
  ...
  const distance = useMemo(() => 
    ...
    [latitude, longitude, restaurant.geometry.location]
  );

  return (
    <div className="bg-white/80 -blur-sm rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
      <div className="p-5">
        ...
        <div className="mt-4">
          <div className={`inline-flex items-center gap-1 px-3 py-1 rounded-lg text-sm font-medium ${
...
export default function Swiggy() {
  ...
  const handleOrderClick = useCallback((restaurant) => {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="animate-pulse text-lg font-medium text-gray-700">
          <iframe src="https://lottie.host/embed/5f0c9b34-70c2-4122-ad54-01e1e01701c0/PrL5bX1Cv8.lottie"></iframe>
          Loading Best Restaurants Near You...
        </div>
      </div>
    );
  }
